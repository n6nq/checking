...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cvEntries = QtWidgets.QColumnView(self.centralWidget)
        self.cvEntries.setGeometry(QtCore.QRect(120, 80, 611, 221))
        self.cvEntries.setAlternatingRowColors(True)
        self.cvEntries.setObjectName("cvEntries")
        ...
        self.cbCleared = QtWidgets.QComboBox(self.centralWidget)
        self.cbCleared.setGeometry(QtCore.QRect(370, 0, 69, 22))
        self.cbCleared.setObjectName("cbCleared")
